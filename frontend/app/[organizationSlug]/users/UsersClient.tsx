...
export default function UsersClient({
  ...
  function descendingComparator(a: UserData, b: UserData, orderBy: keyof UserData) {
    ...
    <Box>
      ...
      >
        ...
        <DialogContent>
          ...
          <Typography variant="body2" color="text.secondary">
            This action will revoke their access to all apps and data within this organization. This action cannot be undone.
          </Typography>
        </DialogContent>
        <DialogActions>
